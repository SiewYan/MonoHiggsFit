...
#		  ,"VH_signal"    	       :['signal_fail','vh',1,0]
		  ...
		  ,"Data_signal_fail"	       :['signal_fail','data',0,0]
                  ,"ZpA0_600_signal_fail"       :['signal_fail','ZpA0-600-300_signal',1,1]
                  ,"ZpA0_800_signal_fail"       :['signal_fail','ZpA0-800-300_signal',1,1]
                  ,"ZpA0_1000_signal_fail"      :['signal_fail','ZpA0-1000-300_signal',1,1]
                  ,"ZpA0_1400_signal_fail"      :['signal_fail','ZpA0-1400-300_signal',1,1]
                  ,"ZpA0_1700_signal_fail"      :['signal_fail','ZpA0-1700-300_signal',1,1]
                  ,"ZpA0_2000_signal_fail"      :['signal_fail','ZpA0-2000-300_signal',1,1]
                  ,"ZpA0_2500_signal_fail"      :['signal_fail','ZpA0-2500-300_signal',1,1]
